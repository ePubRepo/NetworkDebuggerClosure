...
goog.addDependency('../../../js/bootstrap.js', ['Bootstrap', 'netdebugger'], ['AppGuiManager', 'DNSInputHelper', 'DNSResponsePacketAnalyzer', 'NetworkInterfaceInformation', 'OutputRecordManager']);
...
goog.addDependency('../../../js/dnsquerymanager_test.js', ['test.DNSQueryManager'], ['DNSQueryManager', 'DNSUtil', 'OutputRecordManager', 'goog.testing.jsunit']);
...
goog.addDependency('../../../js/dnsrecordaaaa_test.js', ['test.DNSRecordAAAA'], ['DNSRecordAAAA', 'DNSUtil', 'goog.testing.jsunit']);
...
goog.addDependency('../../../js/dnsresponsepacketanalyzer_test.js', ['test.DNSResponsePacketAnalyzer'], ['DNSQueryManager', 'DNSRecord', 'DNSResponsePacketAnalyzer', 'goog.testing.jsunit']);
...
goog.addDependency('../../../js/outputrecordmanager.js', ['OutputRecordManager'], ['OutputRecord']);
goog.addDependency('../../../js/outputrecordmanager_test.js', ['test.OutputRecordManager'], ['OutputRecord', 'OutputRecordManager', 'goog.testing.jsunit']);
...
goog.addDependency('../../../js/testconfigurationparser.js', ['TestConfigurationParser'], ['DNSQueryManager', 'OutputRecordManager', 'Telnet']);
